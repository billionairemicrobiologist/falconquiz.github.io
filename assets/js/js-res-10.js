   ...
   try
   {
       ...
       if(tmpHeading.indexOf('-') > 1)
       {
        /*     tmpHeading = tmpHeading.replace('-', '[#]');
         tmpHeading =  tmpHeading.split('[#]')[0] + ' :: <span class="ib-brown">' + tmpHeading.split('[#]')[1] + '</span>'; */
           $("h1").html(tmpHeading);
       }
...
{ 
    ...
    {      
        ...
        {
            var txtImageHtml = '<table border="0" cellpadding="0" cellspacing="0"><tr><td class="bix-inner-td-option">[XXX]</td><td valign="middle" style="padding-left:10px;"><img src="file:///C:/Users/User/Desktop/Blog/Aptitude%20tests/pictures/accept.png" alt="@" /></td></tr></table>'
