...
(function($) {
  ...
  $.facebox.settings = {
    loading_image : 'file:///C:/Users/User/Desktop/quiz/images/loading.gif',
    close_image   : 'file:///C:/Users/User/Desktop/quiz/images/closelabel.png',
        ...
        <tbody> \
          ...
          <tr> \
            ...
            <td class="body"> \
              ...
              <div class="footer"> \
                <a href="#" class="close"> \
                  <img src="file:///C:/Users/User/Desktop/quiz/images/closelabel.png" title="close" class="close_image" /> \
                </a> \
              </div> \
            </td> \
            <td class="b"/> \
...
window.onerror=silentErrorHandler;   
 ...
 function AllPageSpecificFunctionsLoad() 
 {
     ...
     /* setTimeout(FixAdBlocker, 3000); */
 }
 
 function FixAdBlocker()
 {
     try
     {
         var ua = navigator.userAgent.toLowerCase().replace(/ /g, '');
         
         if(ua.indexOf('ucbrowser') > 0)
         {
             $('html').html('<div style="line-height:1.5; padding:20px; margin:50px; background-color:#f1f1f1; font-size:20px; font-family:Roboto,Arial" align="center"><p>Your browser or app is not supported.</p></div>');
             return;
         }
         
         /* If ad code not found do nothing*/
         if( $('ins.adsbygoogle').length == 0 ) return;
         
         /* If ad unit loaded do nothing */
         if($('ins.adsbygoogle:first').html().trim().length > 500) return;
         
         $('html').html('<div style="line-height:1.5; padding:20px; margin:50px; background-color:#f1f1f1; font-size:20px; font-family:Roboto,Arial" align="center"><p>Please disable your ad blocker and then reload this page.</p><p><a href="#" onclick="location.reload()">Reload this page now.</a></p></div>');
...
{ 
    ...
    {      
        ...
        {
            var txtImageHtml = '<table border="0" cellpadding="0" cellspacing="0"><tr><td class="bix-inner-td-option">[XXX]</td><td valign="middle" style="padding-left:10px;"><img src="file:///C:/Users/User/Desktop/quiz/images/accept.png" alt="@" /></td></tr></table>'
...
function OnlineCompiler(pQuesID)
{
  ...
  $('div#divCompilerOutput_' + pQuesID).html('<img src="file:///C:/Users/User/Desktop/quiz/images/cprogress.gif" alt="Compilation in progress.." />');  
